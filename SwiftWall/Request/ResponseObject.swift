...
class ResponseObject<T> {
    var requestObject:RequestObject<T>//一个ResponseObject必定有一个RequestObject
    var ok:Bool = false
    var statusCode = -1;//http code，200，201，302，304，404，500等
    var error:NSError?
    ...
    */
    ...
    func dump()->String {
        var err = ""
        err+="ok:"+String(ok)+"\n";
        err+="statusCode:"+String(statusCode)+"\n"
